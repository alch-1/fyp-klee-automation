...
JSON_PATH = CUR_DIR + "/config_template.json"
#with open('/home/klee/FYP/parser/config_template.json') as f:
...
for filename, functions in data.items():
    ...
    command = "gcc -nostdinc -E -I/home/klee/pycparser/utils/fake_libc_include -I" + CUR_DIR + "/" + filename + "/include " + "-L" + CUR_DIR + "/" + filename + "/lib " + filename + " > " + filename[:-2] + "_PP.c"
    # print command
    print(command)
    os.system (command)
...
for file in unique_files:
    print("[!] Running compiler on:", file[:-2], "...")
    print(clang(file[:-2]))
